---
name: openspec-ff
description: Fast-forward — create all remaining planning artifacts for an existing change at once. Use when scope is clear and step-by-step review isn't needed.
license: MIT
