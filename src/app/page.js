    ...
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-zinc-200 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 md:px-8">
        ...
        <nav className="hidden items-center gap-5 text-sm font-semibold text-zinc-600 md:flex">
          <a className="inline-flex min-h-8 items-center transition-colors hover:text-zinc-950" href="#endpoint">Endpoint</a>
          <a className="inline-flex min-h-8 items-center transition-colors hover:text-zinc-950" href="#plans">Plans</a>
          <a className="inline-flex min-h-8 items-center transition-colors hover:text-zinc-950" href="#features">Features</a>
        </nav>
        ...
        {isLoaded && isSignedIn ? (
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-zinc-300 bg-white px-4 text-sm font-bold text-zinc-950 transition hover:bg-zinc-100"
            >
              Sign in
            </button>
            <button
...
function EndpointPanel() {
  return (
    <section id="endpoint" className="px-5 py-16 md:px-8">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        <div className="rounded-lg border border-zinc-200 bg-zinc-950 p-5 text-white shadow-[0_24px_70px_rgba(24,24,27,0.18)]">
...
function Plans() {
  ...
  return (
    <section id="plans" className="bg-zinc-950 px-5 py-20 text-white md:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {planTiers.map((plan) => (
            <article
              key={plan.name}
              className={`rounded-lg border p-6 ${plan.featured ? "border-emerald-300 bg-emerald-300 text-zinc-950" : "border-white/10 bg-white/[0.04]"}`}
            >
              ...
              <button
                ...
                className={`mt-8 inline-flex h-12 w-full items-center justify-center rounded-lg px-5 font-black transition ${plan.featured ? "bg-zinc-950 text-white hover:bg-zinc-800" : "bg-white text-zinc-950 hover:bg-zinc-200"
                  }`}
              >
                {plan.cta}
              </button>
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#fbfaf7] text-zinc-950">
      ...
      <section className="relative px-5 pb-14 pt-28 md:px-8 md:pb-20 md:pt-36">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <div className="mb-7 inline-flex items-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm font-bold text-emerald-800">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button
                type="button"
                onClick={() => router.push(USER_START_PATH)}
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-zinc-950 px-6 text-base font-black text-white transition hover:bg-zinc-800"
              >
              ...
              <button
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-6 text-base font-bold text-zinc-950 transition hover:bg-zinc-100"
              >
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-[0_24px_70px_rgba(24,24,27,0.14)]">
      ...
      <section className="px-5 pb-20 md:px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 rounded-lg bg-zinc-950 p-6 text-white md:flex-row md:items-center md:p-8">
          <div>
          ...
          <button
            type="button"
            onClick={() => router.push(USER_START_PATH)}
            className="inline-flex h-12 shrink-0 items-center justify-center rounded-lg bg-emerald-300 px-6 font-black text-zinc-950 transition hover:bg-emerald-200"
          >
            Get API key
          </button>
        </div>
      ...
      <footer className="border-t border-zinc-200 px-5 py-8 text-sm text-zinc-500 md:px-8">
        <div className="mx-auto flex max-w-6xl flex-col justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="flex gap-5">
            <a className="inline-flex min-h-8 items-center hover:text-zinc-950" href="#endpoint">Endpoint</a>
            <a className="inline-flex min-h-8 items-center hover:text-zinc-950" href="#plans">Plans</a>
            <a className="inline-flex min-h-8 items-center hover:text-zinc-950" href="#features">Features</a>
          </div>
        </div>
      </footer>
    </main>
