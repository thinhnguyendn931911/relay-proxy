 ...
 */
export async function handleForcedSSEToJson({ providerResponse, sourceFormat, provider, model, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, userId, clientRawRequest, onRequestSuccess, trackDone, appendLog }) {
