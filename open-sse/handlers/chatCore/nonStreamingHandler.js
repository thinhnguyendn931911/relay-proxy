 ...
 */
export async function handleNonStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, userId, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, trackDone, appendLog, rtkStats }) {
  trackDone();
  ...
  saveUsageStats({ provider, model, tokens: usage, connectionId, apiKey, userId, endpoint: clientRawRequest?.endpoint, rtkStats });
