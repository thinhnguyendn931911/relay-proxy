---
name: openspec-sync
description: Merge delta specs from a change into the main openspec/specs/ directory. Use when the user wants to sync a change's specs before or after archiving.
license: MIT
