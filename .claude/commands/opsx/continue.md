---
name: "OPSX: Continue"
description: "Create the next artifact for an existing change — one step at a time"
category: Workflow
...
**Input**: Optionally specify a change name after `/opsx:continue` (e.g., `/opsx:continue add-auth`). If omitted, infer from context or prompt.
